    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 overflow-auto ">
            <div class="bg-gray-800 border-b border-gray-700 p-6">
                <h2 class="text-3xl font-bold text-white">Add Category</h2>
            </div>
            <div class="">
                <form action="" method="post">
                    @csrf
                        ...
                        <input class="" type="text" name="name" placeholder="Enter Category Name"><br>
                        
                        <label for="" class=" ">Category Description</label>
                        <textarea class="" name="description" id=""></textarea><br>

                        <label for="">Category Image</label>
                        <input type="file" name="image">
                   

                        <input type="submit" value="Add Category" class="hover:bg-gray-700 text-gray-300 hover:text-pink-600 transition cursor-pointer">
