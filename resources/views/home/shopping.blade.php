...
<section class="menu-section p-15 pt-22">
 <div class="btn flex flex-row justify-between">
   <div class="category-btns text-white flex flex-row justify-center items-center gap-10">
    <button class="bg-pink-950 p-2 pr-12 pl-12 rounded-lg  hover:cursor-pointer hover:text-green-500 transition duration-150 ">All</button>
    <button class="bg-pink-950 p-2 pr-12 pl-12 rounded-lg  hover:cursor-pointer hover:text-green-500 transition duration-150 ">Pizza</button>
    <button class="bg-pink-950 p-2 pr-12 pl-12 rounded-lg  hover:cursor-pointer hover:text-green-500 transition duration-150 ">Burger</button>
    <button class="bg-pink-950 p-2 pr-12 pl-12 rounded-lg  hover:cursor-pointer hover:text-green-500 transition duration-150 ">dezzerd</button>
  </div>
  <div class="search flex flex-row gap-7">
    <input type="text" class="bg-white p-1.5 rounded-xl w-64">
    <button class="bg-pink-950 text-white p-2 pr-12 pl-12 rounded-lg  hover:cursor-pointer hover:text-green-500 transition duration-150 ">search</button>
  </div>

 </div>
  <div class="dish-items grid grid-cols-1 gap-10 md:grid md:grid-cols-3 md:gap-10 lg:grid lg:grid-cols-4 lg:gap-10 mt-6">
