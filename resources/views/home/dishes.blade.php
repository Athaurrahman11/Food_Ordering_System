...
<section class="menu-section p-15 pt-22">
  ...
  <div class="text-white text-center ">
    <h3 class="text-5xl md:text-5xl font-bold after-[''] after:w-68 after:h-2 after:block after:bg-green-500 after:m-auto after:mt-4">Choose Your <span class="text-green-500">Meal</span> Category</h3>
