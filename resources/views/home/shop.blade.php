<section class="menu-section p-15">
  ...
  <div class="mt-6 text-right ">
    <a href="{{ uri('shopping') }}" class="text-pink-950 bg-white w-full  rounded-xl hover:bg-green-500 hover:text-white p-2 pl-6 pr-6 md:text-lg font-semibold transision duration-200">All Dishes <i class="ri-arrow-right-line "></i> </a> 
