 <header class="bg-pink-950 flex justify-between items-center p-6 pr-28 pl-28 shadow-2xl relative z-50">
      <div id="title">
        <h1 class="text-green-500 font-bold text-2xl">FABRIO DINE</h1>
      </div>

      <!-- Navigation -->
      <nav id="menu" class="fixed top-0 left-0 h-screen md:h-0 w-64  md:w-fit bg-pink-950 text-white transform -translate-x-full md:translate-x-0 md:static md:flex md:flex-row md:justify-between md:items-center md:space-x-8 p-11 md:p-0 transition-transform duration-150 ease-linear z-5">
        ...
        <a href="#" class="block mt-6 md:mt-0 hover:text-green-500 transition duration-150 relative after:content-['']  after:h-[1.5px] after:bg-green-500 after:block after:w-auto after:opacity-0 after:transition after:duration-150 after:ease-in-out hover:after:opacity-100">Menu</a>
