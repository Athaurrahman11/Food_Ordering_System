 <header class="fixed bg-pink-950 flex justify-between items-center p-6 pr-20 pl-20 md:pr-28 md:pl-33 shadow-2xl w-full  z-50">
      ...
      <nav id="menu" class="fixed top-0 left-0 h-screen md:h-0 w-62  md:w-fit bg-pink-950 text-white transform -translate-x-full md:translate-x-0 md:static md:flex md:flex-row md:justify-between md:items-center md:space-x-8 p-11 md:p-0 transition-transform duration-150 ease-linear z-5">
        ...
        <a href="{{ uri('/') }}" class="block mt-6 md:mt-0 hover:text-green-500 transition duration-150 relative after:content-['']  after:h-[1.5px] md:after:h-[1.7px] lg:after:h-[1.7px] after:bg-green-500 after:block after:w-auto after:opacity-0 after:transition after:duration-150 after:ease-in-out hover:after:opacity-100 md:text-base text-base " id="home">Home</a>
        <a href="{{{ uri('/shopping') }}}" class="block mt-6 md:mt-0 hover:text-green-500 transition duration-150 relative after:content-['']  after:h-[1.5px] md:after:h-[1.7px] lg:after:h-[1. after:bg-green-500 after:block after:w-auto after:opacity-0 after:transition after:duration-150 after:ease-in-out hover:after:opacity-100 md:text-base text-base" >Shop</a>
        <a href="{{ uri('about') }}" class="block mt-6 md:mt-0 hover:text-green-500 transition duration-150 relative after:content-['']  after:h-[1.5px] after:bg-green-500 after:block after:w-auto md:after:h-[1.7px] lg:after:h-[1. after:opacity-0 after:transition after:duration-150 after:ease-in-out hover:after:opacity-100 md:text-base text-base" >About</a>
        <a href="{{ uri('contact') }}" class="block mt-6 md:mt-0 hover:text-green-500 transition duration-150 relative after:content-['']  after:h-[1.5px] after:bg-green-500 after:block after:w-auto after:opacity-0 md:after:h-[1.7px] lg:after:h-[1. after:transition after:duration-150 after:ease-in-out hover:after:opacity-100 md:text-base text-base" >Contact</a>
      </nav>
