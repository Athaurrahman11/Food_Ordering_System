<section class="why menu-section p-15">
  ...
  <div class="why-items grid grid-cols-2 md:grid md:grid-cols-4 gap-2">

    <div class="why-item text-white flex flex-col justift-center items-center gap-2">
      <img src="home/images/Home.png" class="w-46 h-46 md:w-46 md:h-46 lg:w-54 lg:h-54 border-4  border-pink-950 rounded-full p-1 hover:p-0 transision duration-200" alt="">
      <p class="text-[#d2b475] text-base md:text-lg">Fresh Food</p>
    </div>
